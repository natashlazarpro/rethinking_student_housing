...
This is a to do list before publication 

### Fragen 

*! ask Andreas about prologing study in TUB to save the place in student Wohnweim !*
...
Do i need chapter with Gravity Modeling? NO


### general
*change the font of hole notebook (EV)*
...
TODO: давать ссылки на главы с номерами, проверить ссылки между главами

#### calendar

*отправить вторую главу в качесве примера*
...
*write the code for and 3.5*

# Suwala 
are students interested in living near university
